---
name: speckit-gherkin-sync
description: 'Create or update a declarative Gherkin .feature file by extracting user
...
metadata:
  ...
  source: gherkin:commands/speckit.gherkin.sync.md
---
